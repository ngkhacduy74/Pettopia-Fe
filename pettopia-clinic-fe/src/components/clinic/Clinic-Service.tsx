                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-center">
                          <div className="flex items-center justify-center gap-3">
                            ...
                            <button
                              ...
                              title="Xóa dịch vụ"
                            >
                              <Trash2 className="h-5 w-5 text-red-600 hover:text-red-900 transition" />
                            </button>
                          </div>
                        </td>
                      </tr>
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-md w-full p-6">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 bg-red-600 text-white rounded-lg px-4 py-2.5 font-medium hover:bg-red-700 focus:ring-4 focus:ring-red-200 disabled:opacity-60 disabled:cursor-not-allowed transition flex items-center justify-center gap-2"
                disabled={loading}
              >
