    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <Link href="/" className="flex items-center">
                <span className="text-2xl font-bold text-blue-600">Pettopia</span>
                <span className="ml-3 text-gray-600">Pet Care Service</span>
              </Link>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-5xl font-bold mb-6 leading-tight">
                Chơi furrry làm tôi busy
              </h1>
              <p className="text-lg mb-8 text-blue-50">
                Ôi trời ơi những pé furrry làm tôi so sushi thịt chó thì ngon mà thịt mèo làm giả cầy thì tuyệt đỉnh, pet care service nơi làm thịt uy tín.
              </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="relative">
              <div className="bg-gradient-to-br from-cyan-400 to-cyan-600 rounded-3xl overflow-hidden">
                <img 
            ...
            <div>
              <h2 className="text-4xl font-bold text-gray-900 mb-8">Why Choose Pettopia?</h2>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">Experienced Veterinarians</h3>
                    <p className="text-gray-600">Our team of veterinarians has decades of combined experience in all aspects of pet health.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">State-of-the-Art Facility</h3>
                    <p className="text-gray-600">Our hospital is equipped with the latest technology for diagnosis and treatment.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">We treat each pet as if they were our own, with gentle handling and personalized attention.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">We offer emergency care during business hours and have partnerships with 24/7 emergency clinics.</p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Don't just take our word for it. Here's what our clients have to say about their experience with Pettopia</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-md">
              ...
              <p className="text-gray-700 mb-6">"The team at Pettopia is amazing! They took such good care of our dog Max during his surgery. The follow-up care was exceptional, and they were always available to answer our questions."</p>
              <div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-md">
              ...
              <p className="text-gray-700 mb-6">"I've been bringing my cats to Pettopia for years. Dr. Martinez is so gentle with them, and they're always much less stressed than at other vets we've tried. The entire staff genuinely cares about animals."</p>
              <div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-md">
              ...
              <p className="text-gray-700 mb-6">"When our rabbit needed emergency care on a weekend, Pettopia connected us with their emergency partner clinic and followed up first thing Monday morning. The coordination of care was impressive!"</p>
              <div>
      ...
      <section className="bg-blue-600 py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white mb-4">Ready to Schedule Your Pet's Visit?</h2>
          <p className="text-xl text-blue-50 mb-8">Whether it's time for a check-up or your pet needs special care, our team is here to help.</p>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <h3 className="text-2xl font-bold mb-4">Pettopia</h3>
              <p className="text-gray-400 mb-6">Providing exceptional veterinary care for your beloved pets since 2005. Our mission is to ensure every pet lives a healthy and happy life.</p>
              <div className="flex space-x-4">
